...
<body style="margin: 0; padding:0; font-family: 'Lato', sans-serif;">
    <table style="padding: 10px 20px;" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"
        ...
        <tr>
            <td align="center">
                <footer>
                    <p style="font-size: 15px; color:#131417; margin-bottom: 21px;"> https://supplya-frontend.vercel.app/ </p>
                    <p style="color: #131417; margin-top: 30px; font-size: 14px;">Copyright © 2024 Supplya</p>
                </footer>
            </td>
        </tr>
    </table>
        ...
        <td>
          ...
          >
            <img
              ...
              src="https://storage.cloud.google.com/supplyaassets/logos/Supplya%20Logo%20on%20GBG.png"
              alt="logo"
            />
          </div>
          <table
